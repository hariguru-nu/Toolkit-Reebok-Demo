  ...
  return (
    <div
      className={`${styles.sidebar} ${
        closeMenu === false ? styles.sidebar : styles.active
      }`}
    >
      <div
        className={`${styles.logoContainer} ${
          closeMenu === false ? styles.logoContainer : styles.active
        }`}
      >
      ...
      <div
        className={`${styles.burgerContainer} ${
          closeMenu === false ? styles.burgerContainer : styles.active
        }`}
      >
        <div
      ...
      <div
        className={`${styles.contentsContainer} ${
          closeMenu === false ? styles.contentsContainer : styles.active
        }`}
      >
        <ul>
